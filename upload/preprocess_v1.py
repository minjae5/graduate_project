...
text_name = 'make.txt'
filters = "([.,!?])"
audio_dir= "/home/leeyoungsu/practice/multi-speaker-tacotron-tensorflow/datasets/son/" #음성파일 위치 설정

def preprocess_kss(args):
  in_dir = os.path.join(audio_dir, 'audio')
...
def _process_utterance(out_dir, index, wav_path, text):
  wav, _ = audio.load_wav(wav_path) # multi/son/audio/filename
