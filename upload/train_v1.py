...
from models import create_model #타코트론에 hparams 를 설정해주는 함수
from models.datafeeder import DataFeeder #텐서플로우 큐와 세션 실행
  ...
  with tf.Session() as sess:
    try:
     ...
     # threads= tf.train.start_queue_runners(sess=sess, coord=coord)
	  ...
	  #model.inputs[0] is run first element
